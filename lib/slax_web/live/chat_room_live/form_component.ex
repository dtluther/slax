defmodule SlaxWeb.ChatRoomLive.FormComponent do
  ...
  def mount(socket) do
    # TODO: Remove, but this shows that live components run in teh same process as their parent LiveView
    IO.puts("mount in FormComponent, self() (process ID): #{inspect(self())}")
