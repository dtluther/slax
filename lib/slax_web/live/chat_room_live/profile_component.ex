defmodule SlaxWeb.ChatRoomLive.ProfileComponent do
        ...
        <div class="mb-4">
          <%= if @current_user.id == @user.id do %>
            <.form
              ...
              phx-target={@myself}
            >
              <!-- Display the current user's avatar or a preview of the uploaded avatar -->
              <div class="mb-4">
  ...
  # Because of the way LiveView file uploads work, we need to handle the
  # form's phx-change event, but the handler doesn't actually need to do
  # anything
